...
public class GuiBasedKeyControl extends AbstractKeyControl {
	 ...
	 * @param classPath
	 *            Ein separater ClassPath (würde JavaRedux überschreiben).
	 * @param className
	 *            Der Name der Klasse, in der eine Methode bewiesen werden soll.
	 * @param methodName
	 *            Der Name der zu beweisenden Methode.
	 * @param so
	 *            Enthält die Optionen für den Beweis.
	 * @return Gibt für jeden Vertrag an dieser Methode ein Result-Objekt
	 *         zurück.
	...
	/**
	 * Führt alle Beweise für eine Methode durch.
	 * 
	 * @param source
	 *            Die zu beweisende Quellcodeeinheit (ein Ordner)
	 * @param classPath
